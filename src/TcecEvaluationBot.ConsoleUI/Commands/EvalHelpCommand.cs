...
!rand [min] [max] • !calc [expression] • !define [word] • !evalhelp • !evalengines • !temp • !outputmoveson • !outputmovesoff • <eval_bot {this.environmentInformationProvider.VersionNumber}>";
        }
    }
}
